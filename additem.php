...
<head>
    ...
    <title>Add Items | Koperasi</title>
            ...
            <main>
                <div class="container">
                    <div class="table-responsive">
                        <form action="additem2.php" method="post" enctype="multipart/form-data" class="customcontainer">
                            <h1 class="asdf">Add Items</h1>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    ...
                                    <input type="text" class="form-control" name="Addname" placeholder="Tambahkan Nama"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    ...
                                    <input type="number" class="form-control" name="Hbeli"
                                        placeholder="Tambahkan Harga Beli" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    ...
                                    <input type="number" class="form-control" name="Hjual"
                                        placeholder="Tambahkan Harga Jual" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    ...
                                    <input type="number" class="form-control" name="Stock" placeholder="Tambahkan Stock"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    ...
                                    <input type="date" class="form-control" name="Date"
                                        placeholder="Tambahkan Tanggal Pembelian" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="input-group col-sm-5">
                                    <span class="input-group-text">Expired Date</span>
                                    <input type="date" class="form-control" name="EXP"
                                        placeholder="Tambahkan Expired Date" required>
                                </div>
                            </div>
